...
// Custom Theme Colors mirroring DashboardScreen (redesigned to white professional theme)
...
val AccentOrange = Color(0xFF6366F1)
val TextWhite = Color(0xFF111827)
            ...
            bottomBar = {
                NavigationBar(
                    ...
                    navigationItems.forEach { item ->
                        ...
                        val (selectedTabColor, indicatorColor) = when (item) {
                            Screen.Dashboard -> Pair(Color(0xFF10B981), Color(0xFF10B981))
                            Screen.Medicines -> Pair(Color(0xFF6366F1), Color(0xFF6366F1))
                            Screen.Schedule -> Pair(Color(0xFFF59E0B), Color(0xFFF59E0B))
                            Screen.Family -> Pair(Color(0xFF10B981), Color(0xFF10B981))
                            Screen.Profile -> Pair(Color(0xFFEC4899), Color(0xFFEC4899))
                        }
